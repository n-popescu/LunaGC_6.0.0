...
public final class TowerLevelEndNotifyOuterClass {
  ...
  public interface TowerLevelEndNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 next_floor_id = 10;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int NEXT_FLOOR_ID_FIELD_NUMBER = 10;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (nextFloorId_ != 0) {
        output.writeUInt32(10, nextFloorId_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (nextFloorId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, nextFloorId_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < finishedStarCondList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tar_cond_list\030\016 \003(\r\022\025\n\rnext_floor_id\030\n \001" +
      "(\r\022\022\n\nis_success\030\t \001(\010\022\026\n\016continue_state" +
      "\030\004 \001(\r\"\231\001\n\021ContinueStateType\022(\n$CONTINUE" +
    ...
    internal_static_TowerLevelEndNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_TowerLevelEndNotify_descriptor,
        new java.lang.String[] { "RewardItemList", "FinishedStarCondList", "NextFloorId", "IsSuccess", "ContinueState", });
    emu.grasscutter.net.proto.ItemParamOuterClass.getDescriptor();
  }

...
public final class SceneTeamUpdateNotifyOuterClass {
  ...
  public interface SceneTeamUpdateNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .SceneTeamAvatar scene_team_avatar_list = 3;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int SCENE_TEAM_AVATAR_LIST_FIELD_NUMBER = 3;
    ...
    public static final int IS_IN_MP_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (isInMp_ != false) {
        output.writeBool(2, isInMp_);
      }
      for (int i = 0; i < sceneTeamAvatarList_.size(); i++) {
        output.writeMessage(3, sceneTeamAvatarList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      if (isInMp_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(2, isInMp_);
      }
      for (int i = 0; i < sceneTeamAvatarList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, sceneTeamAvatarList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\026scene_team_avatar_list\030\003 \003(\0132\020.SceneTea" +
      "mAvatar\022\020\n\010is_in_mp\030\002 \001(\010B\033\n\031emu.grasscu" +

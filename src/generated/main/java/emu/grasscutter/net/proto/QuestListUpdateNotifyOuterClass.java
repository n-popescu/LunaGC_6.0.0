...
public final class QuestListUpdateNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int QUEST_LIST_FIELD_NUMBER = 10;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < questList_.size(); i++) {
        output.writeMessage(10, questList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < questList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(10, questList_.get(i));
      }

...
public final class AbilityMetaUpdateBaseReactionDamageOuterClass {
  ...
  public interface AbilityMetaUpdateBaseReactionDamageOrBuilder extends
    ...
    /**
     * <code>.AbilityString global_value_key = 10;</code>
    ...
    /**
     * <code>uint32 source_caster_id = 5;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int GLOBAL_VALUE_KEY_FIELD_NUMBER = 10;
    ...
    public static final int SOURCE_CASTER_ID_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (sourceCasterId_ != 0) {
        output.writeUInt32(5, sourceCasterId_);
      }
      if (abilityName_ != null) {
        output.writeMessage(8, getAbilityName());
      }
      if (globalValueKey_ != null) {
        output.writeMessage(10, getGlobalValueKey());
      }
      if (abilityIdentifier_ != null) {
    ...
    public int getSerializedSize() {
      ...
      if (sourceCasterId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, sourceCasterId_);
      }
      if (abilityName_ != null) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (globalValueKey_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(10, getGlobalValueKey());
      }
      if (abilityIdentifier_ != null) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "oto\032\023AbilityString.proto\032\027AbilityIdentif" +
      "ier.proto\"\326\001\n#AbilityMetaUpdateBaseReact" +
      "ionDamage\022$\n\014ability_name\030\010 \001(\0132\016.Abilit" +
      "yString\022(\n\020global_value_key\030\n \001(\0132\016.Abil" +
      "ityString\022.\n\022ability_identifier\030\013 \001(\0132\022." +
      "AbilityIdentifier\022\030\n\020source_caster_id\030\005 " +
      "\001(\r\022\025\n\rreaction_type\030\014 \001(\rB\033\n\031emu.grassc" +
    ...
    internal_static_AbilityMetaUpdateBaseReactionDamage_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AbilityMetaUpdateBaseReactionDamage_descriptor,
        new java.lang.String[] { "AbilityName", "GlobalValueKey", "AbilityIdentifier", "SourceCasterId", "ReactionType", });
    emu.grasscutter.net.proto.AbilityStringOuterClass.getDescriptor();
    emu.grasscutter.net.proto.AbilityIdentifierOuterClass.getDescriptor();
  }
